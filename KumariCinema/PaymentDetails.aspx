<%@ Page Title="Payment Management" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="PaymentDetails.aspx.cs" Inherits="KumariCinema.PaymentDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="data-section">
        <h3 style="font-size: 18px; font-weight: 600; color: #ffffff; margin-bottom: 16px;">All Payments</h3>
        <asp:GridView ID="gvPayments" runat="server" CssClass="grid-view" AllowPaging="true" PageSize="20"
            OnPageIndexChanging="gvPayments_PageIndexChanging" AutoGenerateColumns="false">
            <Columns>
                <asp:BoundField DataField="PaymentID" HeaderText="ID" />
                <asp:BoundField DataField="UserName" HeaderText="Who paid" />
                ...
                <asp:BoundField DataField="PaymentAmount" HeaderText="Amount" DataFormatString="Rs {0:N2}" />
                <asp:BoundField DataField="PaymentStatus" HeaderText="Status" />
            </Columns>
            <PagerStyle HorizontalAlign="Center" />
            <EmptyDataTemplate><tr><td colspan="10" style="text-align:center;padding:20px;color:#94a3b8;">No payments. Payments are created when you confirm a booking.</td></tr></EmptyDataTemplate>
        </asp:GridView>
    </div>
</asp:Content>
