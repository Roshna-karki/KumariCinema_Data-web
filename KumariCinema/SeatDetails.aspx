...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-size: 32px; font-weight: 700; color: #ffffff; margin-bottom: 32px;"><i class="fa-solid fa-couch" style="margin-right: 10px; color: #6B4423;" aria-hidden="true"></i>Seat Management</h1>
